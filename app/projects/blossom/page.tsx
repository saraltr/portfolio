          ...
          <div className="details" key={index}>
            ...
            <div className="process mt-6">
              <div className="step1">
                ...
                <p className=" text-[#d8cfc4] leading-relaxed">
                  Exploring industry trends, competitor branding, and visual elements to establish a strong design direction.
                </p>
              ...
              <p className="text-sm text-[#d8cfc4] leading-relaxed mb-6 max-w-3xl">
                Exploring different symbols that visually represent the brand’s identity, values, and uniqueness.
              </p>
              ...
              <div className="bg-[#3a3533] rounded-lg p-4 shadow-inner border border-[#4e4744] mb-4">
                <h4 className="text-[#e8bcb9] font-semibold mb-2">Design Directions:</h4>
              ...
              <div role="alert" className="bg-[#f9eae1] alert text-[#4A6955]">
                <strong className="">Next Steps:</strong> Evaluating the most effective symbol for refinement and digitization.
              </div>
            </div>
              ...
              <div className="step3 my-5">
                ...
                <div className="bg-[#3a3533] rounded-lg p-4 shadow-inner border border-[#4e4744] mb-4">
                  <h4 className="text-[#e8bcb9] font-semibold mb-2">Design Direction:</h4>
                  <ol className="list-decimal list text-[#f0e2d0]">
            ...
            <div className="step5 my-6">
              ...
              <div className="final mt-6 border-t border-dotted border-[#7d4f50] pt-4">
                <h3 className="text-xl font-semibold text-[#7EA680] mb-2">✦ Final Signature ✦</h3>
                <div className="grid md:grid-cols-2 gap-6 items-start mb-6">
                 <figure className="mb-4">
                  ...
                  />
                  <figcaption className="text-xs text-[#aaa] mt-1">Final Logo Design</figcaption>
                </figure>
                <figure className="mb-4">
                  <Image
                    src={item.mockup}
                    ...
                    className="rounded border border-[#7d4f50]"
                  />
                  <figcaption className="text-xs text-[#aaa] mt-1">Mockup</figcaption>
                </figure>
                </div>
                 <p className="text-center text-[#f0e2d0] mt-6 max-w-xl mx-auto leading-relaxed">
                  This final identity captures the brand’s essence, balances function with personality, and is ready for real-world application across digital and print mediums.
                </p>
              </div>
