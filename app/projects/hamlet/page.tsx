...
export default function Hamlet() {
  return (
    <>
      <main className="mx-4 border p-5 border-[#5b6bc0] bg-[#1a1d2d]">
        <h1 className="text-2xl font-semibold text-center mb-6 text-[#e6e6f2]">
          Hamlet Posters Project
        </h1>
        <section className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 bg-[#23263a] p-5 rounded-lg">
        ...
        <section className="my-5">
          <h2 className="text-3xl font-bold text-[#e6e6f2] mb-2">
          ...
          <div className="grid md:grid-cols-2">
            ...
            <div className="bg-[#e6e6f2] border border-[#5b6bc0] p-6 rounded-b-xl md:rounded-none md:rounded-r-xl shadow-sm space-y-4 flex flex-col justify-between">
              <div>
                <h3 className="text-xl font-semibold text-[#36448C] mb-1">
                  Story Theme
                </h3>
                <p className="text-[#1a1d2d]">
              ...
              <div>
                ...
                <p className="text-[#1a1d2d]">
                  ...
                  (Hamlet’s love interest) and Laertes. Horatio is Hamlet’s
                  loyal friend.
                </p>
              </div>
        ...
        <section className="step1 my-12">
          <h3 className="text-xl font-semibold text-[#e6e6f2] mb-4 border-l-4 border-[#5b6bc0] pl-3">
            Step 1: Sketches
          </h3>

          <p className="text-[#1a1d2d] mb-6 bg-[#e6e6f2] p-4 rounded-xl shadow-sm leading-relaxed">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-start">
            <figure className="w-full">
              ...
              />
              <figcaption className="text-sm mt-3 italic text-center text-[#36448C]">
                Exploration Sketches
              </figcaption>
            </figure>

            <div className="bg-[#e6e6f2] rounded-xl p-6 shadow-inner border border-[#5b6bc0] text-[#1a1d2d]">
              <h4 className="text-[#36448C] font-semibold text-lg mb-4">
                My Picks:
              </h4>
        ...
        <section className="my-6">
          ...
          <div className="grid md:grid-cols-2 gap-6 items-center">
            <figure className="p-4 rounded-lg">
              ...
              />
              <figcaption className="text-sm mt-2 italic text-center text-[#e6e6f2]">
        ...
        <section className="my-12">
          <h3 className="text-xl font-semibold text-[#e6e6f2] mb-6 border-l-4 border-[#5b6bc0] pl-4">
            Step 3: Refinement Sketches
          </h3>

          <div className="grid md:grid-cols-2 gap-8 items-start">
            <figure className="bg-[#e6e6f2] p-4 rounded-xl shadow-md border border-[#5b6bc0]">
              <Image
            ...
            <div className="bg-[#23263a] rounded-xl p-6 shadow-inner border border-[#5b6bc0] text-[#f0e2d0]">
              <h4 className="text-[#e6e6f2] font-semibold text-lg mb-4">
                My Picks:
              </h4>
        ...
        <section className="my-12">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {/* SYMBOL POSTERS */}
            <div>
              <h4 className="text-lg font-semibold text-[#e6e6f2] mb-3">
              ...
              <figure className="mb-6">
                ...
                />
                <figcaption className="text-sm italic text-center text-[#e6e6f2] mt-2">
              ...
              <div className="space-y-6">
                ...
                <figure className="">
                  ...
                  />
                  <figcaption className="text-sm text-[#f0e2d0] mt-3 bg-[#23263a] p-4 rounded-xl border border-[#5b6bc0]">
            ...
            <div>
              ...
              <div className="space-y-6">
                ...
                <figure className="">
                  ...
                  />
                  <figcaption className="text-sm text-[#f0e2d0] mt-3 bg-[#23263a] p-4 rounded-xl border border-[#5b6bc0]">
                    I adjusted the blue hue for cohesion and refined the type
                    alignment to improve readability and guide the viewers eye.
                  </figcaption>
                </figure>
                <br />
                <h4 className="text-lg font-semibold text-[#e6e6f2] mb-3">
        ...
        <div className="text-center my-6 text-[#e6e6f2] text-xs font-mono">
          ─────── ★ · . · ☆ · . · ★ ───────
        </div>
      </main>
    </>
